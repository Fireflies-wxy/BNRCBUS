 ...
 */
public class BusTags extends View {
    ...
    public BusTags(Context context) {
        this(context, null);
    }

    public BusTags(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BusTags(Context context, AttributeSet attrs, int defStyleAttr) {

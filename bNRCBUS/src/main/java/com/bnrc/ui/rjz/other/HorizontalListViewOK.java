 ...
 */
public class HorizontalListViewOK extends AdapterView<ListAdapter> implements
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(HorizontalListViewOK view, int scrollState);
         ...
         */
        public void onScroll(HorizontalListViewOK view, int firstVisibleItem, int visibleItemCount,
                int totalItemCount);
    }
     ...
     *
     * @see HorizontalListViewOK.RecycleBin
     * @see HorizontalListViewOK#setRecyclerListener(HorizontalListViewOK.RecyclerListener)
     */
    ...
    public HorizontalListViewOK(Context context) {
        this(context, null);
    }

    public HorizontalListViewOK(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalListViewOK(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HorizontalListViewOK, defStyle, 0);

        mDrawSelectorOnTop = a.getBoolean(
                R.styleable.HorizontalListViewOK_android_drawSelectorOnTop, false);

        Drawable d = a.getDrawable(R.styleable.HorizontalListViewOK_android_listSelector);
        if (d != null) {
            setSelector(d);
        }
        ...
        int choiceMode = a.getInt(R.styleable.HorizontalListViewOK_android_choiceMode, -1);
        if (choiceMode >= 0) {
     ...
     *
     * @see HorizontalListViewOK.RecycleBin
     * @see HorizontalListViewOK.RecyclerListener
     */
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(HorizontalListViewOK.this, originalView,
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(HorizontalListViewOK.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(HorizontalListViewOK.class.getName());
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(HorizontalListViewOK.this, child,
                    longPressPosition, longPressId);
        }

        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(HorizontalListViewOK.this);
        }
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (HorizontalListViewOK.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                HorizontalListViewOK.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (HorizontalListViewOK.this.mHasStableIds) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = HorizontalListViewOK.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link HorizontalListViewOK#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link HorizontalListViewOK#arrowScrollFocused} returns its values.
         */

...
public class PinnedHeaderExpandableConcernAdapter extends
		BaseExpandableListAdapter implements HeaderAdapter {
	private static final String TAG = PinnedHeaderExpandableConcernAdapter.class
			.getSimpleName();
	private List<Group> groups;
	private Context mContext;
	private PinnedHeaderExpandableConcernListView listView;
	private LayoutInflater inflater;
	private IPopWindowListener mOnSelectBtn;
	private int mSubTextType = -1;
	private int mConcernType = -1;
	private RandomColor mColor = RandomColor.MATERIAL;

	public PinnedHeaderExpandableConcernAdapter(List<Group> groups,
		...
		this.mSubTextType = subtitletype;
		this.mConcernType = concernType;
	}
